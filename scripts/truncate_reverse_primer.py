...
script_info['script_usage'].append(("""Example:""","""Find, truncate reverse primers from the fasta file seqs.fna, write output fasta file to the reverse_primer_removed directory:""","""truncate_reverse_primer.py -f seqs.fna -m Mapping_File_Rev_Primer.txt -o reverse_primer_removed/"""))
