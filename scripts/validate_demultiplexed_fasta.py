...
script_info={}
script_info['brief_description']="""Checks a fasta file to verify if it has been properly demultiplexed, i.e., it is in QIIME compatible format.  Also can test for matching SampleIDs between a given fasta file and a mapping file, or test for matching fasta labels and tree tips."""
...
script_info['script_usage'].append(("""Example:""",""" """,""" validate_demultiplexed_fasta.py -i seqs.fasta -m Mapping_File.txt"""))
